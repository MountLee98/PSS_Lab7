...
public class PDFCreator {
    ...
    public PDFCreator(Delegation delegation) {
    ...
    private void tableContent(PdfPTable table) throws IOException {
        ...
        table.addCell(cell);
        cellD.setPhrase(new Phrase(delegation.getTransportType().toString(), fontRight));
        table.addCell(cellD);
        ...
        table.addCell(cell);
        cellD.setPhrase(new Phrase(delegation.getAutoCapacityl().toString(), fontRight));
        table.addCell(cellD);
